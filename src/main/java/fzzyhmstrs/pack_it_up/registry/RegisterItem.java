...
public class RegisterItem {
    ...
    public static final Item CACTUSPACK_BAG = register("cactuspack_bag",new BagItem(new Item.Settings().maxCount(1).group(PIU_GROUP)));
    ...
    public static final Item CACTUSPACK = register("cactuspack",new PackItem(new Item.Settings().maxCount(1).recipeRemainder(CACTUSPACK_BAG).group(PIU_GROUP), PackItem.ModuleTier.CACTUS, PackItem.StackPredicate.CACTUS));
