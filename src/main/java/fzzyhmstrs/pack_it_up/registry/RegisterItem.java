...
public class RegisterItem {
    ...
    public static final Item CACTUSPACK = register("cactuspack",new PackItem(new Item.Settings().maxCount(1).recipeRemainder(CACTUSPACK_BAG), PackItem.ModuleTier.CACTUS, PackItem.StackPredicate.ANY));
